...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  queue.o register.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
queue.o: /cygdrive/C/eclipse/workspace/testqueue/queue.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/testqueue/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
queue.o: /cygdrive/C/eclipse/workspace/testqueue/queue.cpp \
 /cygdrive/C/eclipse/workspace/testqueue/queue.h \
